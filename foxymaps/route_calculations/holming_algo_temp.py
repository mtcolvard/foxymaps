...
def run_homing_algo(all_waypoints):
    ...
    for waypoint_id in waypoint_ids:
        ...
        for each_id in waypoint_ids:
            ...
            waypoints_graph[waypoint_id][each_id] = crowflys_bearing(waypoints_lon_lat[waypoint_id][0], waypoints_lon_lat[each_id][0], waypoints_lon_lat[each_id][1])
...
def filter_graph_by_angle_then_distance(waypoints_graph):
    ...
    # Sort to find closest park
        ...
        # next_park_size = angle_filtered_park_options[parks_sorted_by_distance][0][]
        ...
        # print('distance_to_closest_park', distance_to_closest_park)
        # print('distance_to_second_closest_park', distance_to_second_closest_park)
        # print('platonic_width_of_second_closest_park_hecarage', platonic_width_of_second_closest_park_hecarage)
